...
const { SET_STEP_ONE_REQUESTS,
   ADD_MULTICITY,SET_STEP_TWO_TRIP_REQUEST_REASON, SET_STEP_ONE_DEPART_DATE,SET_STEP_ONE_RETURN_DATE, SET_STEP_TWO_TRIP_REQUEST_REMEMBER_ME,INITIALIZE,UPDATE_TRIP_REQUEST } = actionTypes;
  ...
  switch (action.type) {
    ...
    case SET_STEP_ONE_RETURN_DATE:
      ...
      case ADD_MULTICITY:
        return {
          ...state,
          stepOne:{...state.stepOne, requests: 
           [...state.stepOne.requests,action.payload,]
          }
        };
