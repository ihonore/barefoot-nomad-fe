...
function AccommodationDeleteModal({
  isOpen,
  handleClose,
  accommodation,
  modalId,
  deleteAccommodation,
  accommodationDeleteData,
  fetchAccommodations,
  showSuccessSnackbar,
}) {
      ...
      >
        <Box sx={style}>
          <Typography id={modalId} variant="h5" component="h2">
            {t('Are sure you want to remove')} {accommodation.accommodationName}
            ?
          </Typography>
          <Typography variant="body1" component="h2">
            {t('street')}: {accommodation.streetAddress}
          </Typography>
          <br />
